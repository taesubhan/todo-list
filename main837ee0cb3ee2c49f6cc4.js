...
/* harmony import */ var _dom_functions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom-functions.js */ "./src/dom/dom-functions.js");
/* harmony import */ var _images_icons_cog_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../images/icons/cog.svg */ "./src/images/icons/cog.svg");
...
function addProjectSettingsIcon() {
    ...
    settingsIcon.src = _images_icons_cog_svg__WEBPACK_IMPORTED_MODULE_3__;
    settingsIcon.classList.add('project-settings');
    settingsIcon.addEventListener('click', () => {
        (0,_dialog_box_js__WEBPACK_IMPORTED_MODULE_1__.displayProjectSettingsDialog)();  
    })
...
function getTaskDetailsButton(projIndex, taskIndex) {
    ...
    detailButton.addEventListener('click', (e) => {
        (0,_dialog_box_js__WEBPACK_IMPORTED_MODULE_1__.editAndOpenTaskDetailDialog)(projIndex, taskIndex);
    })
...
function getTasksDOM(taskList) {
    ...
    for (let i = 0; i < taskList.length; i++) {
        ...
        let taskIndex;
        let taskObj;
        const menuCategory = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedMenuCategory();
        
        if (menuCategory === 'tasksByDate') {
            const loc = taskList[i];
            projIndex = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getProjectIndex(loc);
            taskIndex = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getTaskIndex(loc);
            taskObj = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getTaskFromIndex(projIndex, taskIndex);
        } else if (menuCategory === 'projects') {
            projIndex = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedProjectIndex();
            taskIndex = i;
            taskObj = taskList[i];
        }
...
function displayTaskList() {  
    const selectedMenu = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedMenuCategory();

    if (selectedMenu === 'projects') {
        createProjectDOM(_logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedProject());
    } else if (selectedMenu === 'tasksByDate') {
        createTodayDOM(_logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getTasksDueToday());
    } else {
        createProjectDOM(_logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedProject());
    }
}
...
function deleteTaskDisplay() {
    const projectContainer = document.querySelector('.project-container');
    (0,_dom_functions_js__WEBPACK_IMPORTED_MODULE_2__.deleteAllChildren)(projectContainer);
}
...
function displayPeriodsOnMenu() {
    ...
    if (_logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedMenuCategory() === 'tasksByDate') {
    ...
    today.addEventListener('click', () => {
        _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.setSelectedMenuCategory('tasksByDate');
        updateDisplay();
    });
...
function deletePeriodsOnMenu() {
    const taskPeriodMenu = document.querySelector('.task-period-list-container');
    (0,_dom_functions_js__WEBPACK_IMPORTED_MODULE_2__.deleteAllChildren)(taskPeriodMenu);
}
...
function displayProjectsOnMenu() {
    ...
    const selectedProjectIndex = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedProjectIndex();
    const menuCategory = _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedMenuCategory();
...
function deleteProjectsOnMenuDisplay() {
    ...
    (0,_dom_functions_js__WEBPACK_IMPORTED_MODULE_2__.deleteAllChildren)(projectsMenu);
}
...
/* harmony import */ var _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../logic/todo-state.js */ "./src/logic/todo-state.js");
/* harmony import */ var _dialog_box_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dialog-box.js */ "./src/dom/dialog-box.js");
/* harmony import */ var _display_on_screen_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display-on-screen.js */ "./src/dom/display-on-screen.js");
/* harmony import */ var _images_icons_format_list_checks_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../images/icons/format-list-checks.svg */ "./src/images/icons/format-list-checks.svg");
...
function insertTabIcon() {
    ...
    link.setAttribute('href', _images_icons_format_list_checks_svg__WEBPACK_IMPORTED_MODULE_3__);
...
function start() {
    insertTabIcon();
    _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.setSelectedMenuCategory('tasksByDate');
    (0,_display_on_screen_js__WEBPACK_IMPORTED_MODULE_2__.displayAll)();
    (0,_dialog_box_js__WEBPACK_IMPORTED_MODULE_1__.addDialogButtonActions)();
}
...
function createDummyProjectsAndTasks() {
    ...
    const task1 = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)('Respond to Emails', 'There is a backlog of emails to answer', '2024-04-10', 'High');
    const task2 = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)('Train New Employee', 'New employee needs to be trained on our platform', 
                        '2024-04-21', 'Medium');
    const task3 = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)('Do Laundry', 'Laundry basket is almost full', '2024-04-14', 'Medium');
    const task4 = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)('Wash Dishes', 'Dishes are dirty', '2024-04-13', 'High');
    const task5 = (0,_task_js__WEBPACK_IMPORTED_MODULE_0__.task)('Change Lightbulb', 'Lightbulb has been flickering for a few days', '2024-04-18', 'Low');
...
/***/ "./src/images/icons/format-list-checks.svg":
/*!*************************************************!*\
  !*** ./src/images/icons/format-list-checks.svg ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "images/format-list-checks-b11d2b03a072fc292419.svg";
