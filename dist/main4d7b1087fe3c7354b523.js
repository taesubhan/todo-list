...
function addTaskDetailDialogButtons() {
    ...
    confirmEditButton.addEventListener('click', () => {
        ...
        _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.updateTaskFromSelectedProject(taskIndex, taskObj);
...
function addCreatingTaskDialog() {
    ...
    confirmButton.addEventListener('click', (e) => {
        if (taskForm.reportValidity()) {   
            ...
            _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.addTaskToSelectedProject(newTask);
            (0,_display_on_screen_js__WEBPACK_IMPORTED_MODULE_1__.updateDisplay)();
        }
    })
...
function getTasksDOM(taskList) {
    ...
    for (let i = 0; i < taskList.length; i++) {
        ...
        for (let prop in properties) {
            ...
            if (prop === 'dueDate') {
                taskProperty.textContent = (0,_dom_functions_js__WEBPACK_IMPORTED_MODULE_2__.formatDate)(taskObj[prop]);
            } else if (prop === 'title') {
...
function displayProjectsOnMenu() {
    ...
    for (let i = 0; i < projectListArray.length; i++) {
        ...
        projectItem.addEventListener('click', () => {
            _logic_todo_state_js__WEBPACK_IMPORTED_MODULE_0__.setNewSelectedProject(i);
            updateDisplay();
        });
